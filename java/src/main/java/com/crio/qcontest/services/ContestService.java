...
public class ContestService{
    ...
    public List<Contestant> contestHistory(Long contestId) {
        ...
        return contestantRepository.findAllByContestId(contestId).stream().sorted((c1,c2)->
             c2.getCurrentContestPoints() - c1.getCurrentContestPoints()).collect(Collectors.toList());
    }
}
